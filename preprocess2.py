#This script replaces the processes with empty DLL files with the word 'NULL' and encloses the whole line in braces to treat all the DLL files as single entity
